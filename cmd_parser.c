...
/**
 * is_cmd - checks if the provided path points to an executable
...
/**
 * dup_chars - creates a copy of a subset of characters from a string
...
/**
 * find_path - searches for a command's path within the PATH variable
